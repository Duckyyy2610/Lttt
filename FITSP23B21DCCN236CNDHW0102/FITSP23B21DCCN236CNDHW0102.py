...
if __name__ == "__main__":
    ...
    with open('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\input\\FITSP23B21DCCN236CNDHW0102.txt', 'r') as file:
    ...
    with open('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\input\\FITSP23B21DCCN236CNDHW0102 (a-z, space, endline characters).txt',
              'r') as file:
        read_file = file.readlines()
    ...
    with open('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\input\\FITSP23B21DCCN236CNDHW0102 (decode).txt', 'r') as file:
        read_file = file.readlines()
        code = read_file
    ...
    # Lưu vào file phần 1
    write_file_2('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\\output', 'FITSP23B21DCCN236CNDHW0102(output 1).txt', huffman_codes_1,
                 symbol_probabilities)

    # Lưu vào file phần 2
    write_file_2('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\\output', 'FITSP23B21DCCN236CNDHW0102(output 2).txt', huffman_codes_2,
                 symbol_probabilities_2)

    # Lưu vào file phần 3
    write_file('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\\output', 'FITSP23B21DCCN236CNDHW0102(output 3).txt', decoded_string)

    # Lưu vào file phần 3 khi đã giải mã
    write_file_2('C:\\hk2\\lttt\\btl\\FITSP23B21DCCN236CNDHW0102\\output', 'FITSP23B21DCCN236CNDHW0102(output 4).txt',
